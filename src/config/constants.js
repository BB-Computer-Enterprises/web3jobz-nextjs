...
export const NEXT_PUBLIC_SUPABASE_URL = isLocal ? process.env.NEXT_PUBLIC_SUPABASE_URL : process.env.NEXT_PUBLIC_SUPABASE_URL_PROD;
export const NEXT_PUBLIC_SUPABASE_KEY = isLocal ? process.env.NEXT_PUBLIC_SUPABASE_KEY : process.env.NEXT_PUBLIC_SUPABASE_KEY_PROD;

export const HOME_PAGE_FETCH_URL = process.env.NEXT_PUBLIC_HOME_PAGE_FETCH_URL;
export const HOME_PAGE_API_KEY = process.env.NEXT_PUBLIC_HOME_PAGE_API_KEY;
